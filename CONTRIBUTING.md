...
Thank you for your interest in `strongloop-buildpacks`, an open source project
administered by StrongLoop.

Contributing to `strongloop-buildpacks` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/strongloop-buildpacks)
